                        ...
                        case 2:
                            ...
                            if (!empty($learner_timetable)){
                                foreach ($learner_timetable as $learner_timedata) {
                                    $learner_timetable_id = $learner_timedata[0][0];
                                    break;
                                }
                            } else {
                                ...
                                if (!empty($learner_result)) {
                                    foreach ($learner_result as $learner_data) {
                                        $learner_timetable_id = $learner_data[0][0];
                                        break;
                                    }
                                } else { 
                                ...
                                $q = "INSERT INTO schoollms_schema_userdata_learner_timetable VALUES ($user_id, $learner_timetable_id, $year_id, 'NEW')";
                                $learner_result = sqlQuery($q);
